...
export const en: Translation = {
  ...
  testimonials: {
    ...
    items: [
      ...
      {
        quote: 'The Odoo implementation was complex, but the team guided us through every step. We now have full visibility into our operations for the first time.',
